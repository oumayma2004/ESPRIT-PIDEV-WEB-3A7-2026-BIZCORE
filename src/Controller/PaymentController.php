...
class PaymentController extends AbstractController
{
    ...
    public function checkout(Request $request): Response
    {
        ...
        // Build success URL: keep {CHECKOUT_SESSION_ID} un-encoded for Stripe
    ...
    /**
     * Page de succès — récupère les infos Stripe et envoie un SMS de confirmation
     */
    ...
    public function success(Request $request): Response
    {
        ...
        // Paiement confirmé par Stripe → vider panier + envoyer SMS
