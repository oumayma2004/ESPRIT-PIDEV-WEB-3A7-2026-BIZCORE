...
class ReservationEvenementController extends AbstractController
{
    ...
    public function pay(InscriptionEvenement $reservation, Request $request, EntityManagerInterface $em, LoggerInterface $logger): Response
    {
        $this->denyReservationAccess($reservation);
        ...
        try {
            ...
            $logger->error('Stripe reservation payment restart failed.', [
