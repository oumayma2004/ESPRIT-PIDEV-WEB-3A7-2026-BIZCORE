...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Form\\CommentaireEvenementType' => ['privates', 'App\\Form\\CommentaireEvenementType', 'getCommentaireEvenementTypeService', true],
            'App\\Form\\DisponibiliteType' => ['privates', 'App\\Form\\DisponibiliteType', 'getDisponibiliteTypeService', true],
            'App\\Form\\DomaineCoachingType' => ['privates', 'App\\Form\\DomaineCoachingType', 'getDomaineCoachingTypeService', true],
            'App\\Form\\EvenementType' => ['privates', 'App\\Form\\EvenementType', 'getEvenementTypeService', true],
            'App\\Form\\InscriptionEvenementType' => ['privates', 'App\\Form\\InscriptionEvenementType', 'getInscriptionEvenementTypeService', true],
            'App\\Form\\ReservationType' => ['privates', 'App\\Form\\ReservationType', 'getReservationTypeService', true],
            'App\\Form\\SellProductType' => ['privates', 'App\\Form\\SellProductType', 'getSellProductTypeService', true],
            'App\\Form\\SignalementArticleType' => ['privates', 'App\\Form\\SignalementArticleType', 'getSignalementArticleTypeService', true],
            'App\\Form\\VendorType' => ['privates', 'App\\Form\\VendorType', 'getVendorTypeService', true],
            ...
            'App\\Form\\CoachType' => '?',
            'App\\Form\\CommentaireEvenementType' => '?',
            'App\\Form\\DisponibiliteType' => '?',
            'App\\Form\\DomaineCoachingType' => '?',
            'App\\Form\\EvenementType' => '?',
            'App\\Form\\InscriptionEvenementType' => '?',
            'App\\Form\\ReservationType' => '?',
            'App\\Form\\SellProductType' => '?',
            'App\\Form\\SignalementArticleType' => '?',
            'App\\Form\\VendorType' => '?',
