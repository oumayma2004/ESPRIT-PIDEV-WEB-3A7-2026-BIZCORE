...
class __TwigTemplate_9a18231be6ceaceb75bea50df3f55257 extends Template
{
...
";
        // line 101
        if ((($tmp = (isset($context["recaptchaEnabled"]) || array_key_exists("recaptchaEnabled", $context) ? $context["recaptchaEnabled"] : (function () { throw new RuntimeError('Variable "recaptchaEnabled" does not exist.', 101, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 102
            yield "<script src=\"https://www.google.com/recaptcha/api.js?render=";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["recaptchaSiteKey"]) || array_key_exists("recaptchaSiteKey", $context) ? $context["recaptchaSiteKey"] : (function () { throw new RuntimeError('Variable "recaptchaSiteKey" does not exist.', 102, $this->source); })()), "html", null, true);
            yield "\"></script>
<script>
    ...
    form.addEventListener('submit', function (e) {
        ...
        grecaptcha.ready(function () {
            grecaptcha.execute('";
            // line 124
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["recaptchaSiteKey"]) || array_key_exists("recaptchaSiteKey", $context) ? $context["recaptchaSiteKey"] : (function () { throw new RuntimeError('Variable "recaptchaSiteKey" does not exist.', 124, $this->source); })()), "html", null, true);
...
";
    ...
    {
        return array (  253 => 124,  227 => 102,  225 => 101,  218 => 97,  208 => 90,  199 => 84,  186 => 74,  177 => 68,  170 => 64,  161 => 58,  158 => 57,  152 => 55,  150 => 54,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endif %}
{% endblock %}
", "security/register.html.twig", "C:\\Users\\MSI\\Desktop\\final_bizcore\\ESPRIT-PIDEV-WEB-3A7-2026-BIZCORE\\templates\\security\\register.html.twig");
    }
}
