...
class __TwigTemplate_64f786b2e82bf3d8ea8e0a68ebe742c5 extends Template
{
...
";
    ...
    <div style=\"margin-bottom:20px;\">
        <a href=\"";
        // line 17
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_coach_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["coach"]) || array_key_exists("coach", $context) ? $context["coach"] : (function () { throw new RuntimeError('Variable "coach" does not exist.', 17, $this->source); })()), "idCoach", [], "any", false, false, false, 17)]), "html", null, true);
    ...
    <div class=\"card-panel\">
        <div style=\"border-bottom:1px solid #f1f5f9;padding-bottom:16px;margin-bottom:24px;display:flex;align-items:center;gap:12px;\">
            <div style=\"width:42px;height:42px;border-radius:10px;background:linear-gradient(135deg,#f59e0b,#d97706);display:flex;align-items:center;justify-content:center;color:#fff;font-size:18px;\">
                <i class=\"fas fa-pen\"></i>
            </div>
            <div>
                <h2 style=\"font-size:17px;font-weight:700;color:#111827;margin:0;\">Modifier : ";
        // line 28
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["coach"]) || array_key_exists("coach", $context) ? $context["coach"] : (function () { throw new RuntimeError('Variable "coach" does not exist.', 28, $this->source); })()), "prenom", [], "any", false, false, false, 28), "html", null, true);
        yield " ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["coach"]) || array_key_exists("coach", $context) ? $context["coach"] : (function () { throw new RuntimeError('Variable "coach" does not exist.', 28, $this->source); })()), "nom", [], "any", false, false, false, 28), "html", null, true);
        yield "</h2>
                <p style=\"font-size:12px;color:#6b7280;margin:2px 0 0;\">Coach #";
        // line 29
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["coach"]) || array_key_exists("coach", $context) ? $context["coach"] : (function () { throw new RuntimeError('Variable "coach" does not exist.', 29, $this->source); })()), "idCoach", [], "any", false, false, false, 29), "html", null, true);
        yield "</p>
            </div>
        </div>
        ...
        <div style=\"margin-top:24px;padding-top:20px;border-top:1px solid #f1f5f9;display:flex;gap:10px;\">
            ...
            <a href=\"";
        // line 85
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_coach_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["coach"]) || array_key_exists("coach", $context) ? $context["coach"] : (function () { throw new RuntimeError('Variable "coach" does not exist.', 85, $this->source); })()), "idCoach", [], "any", false, false, false, 85)]), "html", null, true);
...
";
    ...
    {
        return array (  359 => 96,  346 => 95,  331 => 90,  323 => 85,  310 => 75,  305 => 73,  298 => 69,  294 => 68,  287 => 64,  283 => 63,  276 => 59,  272 => 58,  265 => 54,  261 => 53,  254 => 49,  250 => 48,  243 => 44,  239 => 43,  232 => 39,  228 => 38,  220 => 33,  213 => 29,  207 => 28,  193 => 17,  188 => 14,  175 => 13,  162 => 10,  153 => 7,  140 => 6,  117 => 4,  94 => 3,  68 => 2,  45 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{% extends 'base.html.twig' %}
{% block title %}Modifier — {{ coach.prenom }} {{ coach.nom }}{% endblock %}
...
<div style=\"max-width:820px;\">
    ...
    <div style=\"margin-bottom:20px;\">
        <a href=\"{{ path('app_coach_show', {'id': coach.idCoach}) }}\" style=\"color:var(--accent);text-decoration:none;font-size:13px;font-weight:600;\">
            <i class=\"fas fa-arrow-left\"></i> Retour au profil
        </a>
    </div>
    ...
    <div class=\"card-panel\">
        <div style=\"border-bottom:1px solid #f1f5f9;padding-bottom:16px;margin-bottom:24px;display:flex;align-items:center;gap:12px;\">
            ...
            <div>
                <h2 style=\"font-size:17px;font-weight:700;color:#111827;margin:0;\">Modifier : {{ coach.prenom }} {{ coach.nom }}</h2>
                <p style=\"font-size:12px;color:#6b7280;margin:2px 0 0;\">Coach #{{ coach.idCoach }}</p>
            </div>
        </div>
        ...
        <div style=\"margin-top:24px;padding-top:20px;border-top:1px solid #f1f5f9;display:flex;gap:10px;\">
            ...
            <a href=\"{{ path('app_coach_show', {'id': coach.idCoach}) }}\" class=\"btn-outline-teal\" style=\"padding:10px 20px;text-decoration:none;display:inline-flex;align-items:center;gap:6px;\">
                <i class=\"fas fa-times\"></i> Annuler
            </a>
        </div>
...
{% endblock %}
", "coach/edit.html.twig", "C:\\Users\\MSI\\Desktop\\final_bizcore\\ESPRIT-PIDEV-WEB-3A7-2026-BIZCORE\\templates\\coach\\edit.html.twig");
    }
}
