...
class __TwigTemplate_bd1c8d20e2af5ce3ed6e1733ec8fa061 extends Template
{
...
";
    ...
    ";
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 237, $this->source); })()), "flashes", ["success"], "method", false, false, false, 237));
    ...
    ";
        ...
        yield "    ";
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 240, $this->source); })()), "flashes", ["error"], "method", false, false, false, 240));
        foreach ($context['_seq'] as $context["_key"] => $context["msg"]) {
            // line 241
...
";
    ...
    {
        return array (  575 => 329,  571 => 324,  557 => 311,  551 => 306,  545 => 301,  541 => 298,  527 => 289,  522 => 288,  519 => 286,  512 => 280,  504 => 274,  490 => 262,  484 => 257,  475 => 249,  471 => 246,  467 => 243,  458 => 241,  453 => 240,  444 => 238,  440 => 237,  437 => 236,  425 => 225,  412 => 223,  220 => 40,  207 => 39,  191 => 33,  187 => 32,  181 => 29,  177 => 28,  171 => 25,  167 => 24,  161 => 21,  156 => 20,  149 => 16,  144 => 15,  137 => 11,  132 => 10,  130 => 9,  126 => 7,  113 => 6,  90 => 4,  67 => 3,  44 => 1,);
    }
...
<div class=\"content\">
    ...
    {# Stat pills — populated by JS via /api/articles/stats #}
    ...
    {# Category tabs — populated by JS via /api/articles/categories #}
    ...
    <div class=\"section-header\">
        ...
        <div class=\"section-right\">
            ...
            <a href=\"{{ path('signalement_index') }}\" class=\"btn-signalement\">🚩 Mes signalements</a>
            <button class=\"btn-stats\" onclick=\"openStats()\">📊 Statistiques</button>
        </div>
    </div>
...
{# ══ STATISTICS MODAL ════════════════════════════════════════════ #}
<div class=\"modal-overlay\" id=\"statsModal\" onclick=\"handleOverlayClick(event)\">
    <div class=\"modal\">
        <div class=\"modal-header\">
            <div class=\"modal-title\">📊 Statistiques du Blog</div>
            <button class=\"modal-close\" onclick=\"closeStats()\">✕</button>
...
{# ══════════════════════════════════════════════════════════════════
   JAVASCRIPT — all API calls live here
══════════════════════════════════════════════════════════════════ #}
<script>
// ────────────────────────────────────────────────────────────────
// STATE
...
{% endblock %}
", "blog/index.html.twig", "C:\\Users\\MSI\\Desktop\\final_bizcore\\ESPRIT-PIDEV-WEB-3A7-2026-BIZCORE\\templates\\blog\\index.html.twig");
    }
}
