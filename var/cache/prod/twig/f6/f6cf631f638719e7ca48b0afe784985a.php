...
class __TwigTemplate_55c4db52642b1750aeac2c69d83c2630 extends Template
{
...
";
    ...
    <div style=\"margin-bottom:20px;\">
        <a href=\"";
        // line 17
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_coach_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["coach"] ?? null), "idCoach", [], "any", false, false, false, 17)]), "html", null, true);
    ...
    <div class=\"card-panel\">
        ...
        // line 28
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["coach"] ?? null), "prenom", [], "any", false, false, false, 28), "html", null, true);
        yield " ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["coach"] ?? null), "nom", [], "any", false, false, false, 28), "html", null, true);
        yield "</h2>
                <p style=\"font-size:12px;color:#6b7280;margin:2px 0 0;\">Coach #";
        // line 29
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["coach"] ?? null), "idCoach", [], "any", false, false, false, 29), "html", null, true);
        yield "</p>
            </div>
        </div>
        ...
        <div style=\"margin-top:24px;padding-top:20px;border-top:1px solid #f1f5f9;display:flex;gap:10px;\">
            ...
            <a href=\"";
        // line 85
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_coach_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["coach"] ?? null), "idCoach", [], "any", false, false, false, 85)]), "html", null, true);
...
";
    ...
    {
        return array (  281 => 96,  274 => 95,  265 => 90,  257 => 85,  244 => 75,  239 => 73,  232 => 69,  228 => 68,  221 => 64,  217 => 63,  210 => 59,  206 => 58,  199 => 54,  195 => 53,  188 => 49,  184 => 48,  177 => 44,  173 => 43,  166 => 39,  162 => 38,  154 => 33,  147 => 29,  141 => 28,  127 => 17,  122 => 14,  115 => 13,  108 => 10,  99 => 7,  92 => 6,  81 => 4,  70 => 3,  56 => 2,  45 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "coach/edit.html.twig", "C:\\Users\\MSI\\Desktop\\final_bizcore\\ESPRIT-PIDEV-WEB-3A7-2026-BIZCORE\\templates\\coach\\edit.html.twig");
    }
}
