...
class __TwigTemplate_6de9cdc2a32cc3bce55a299aad6742e9 extends Template
{
...
<div style=\"display:flex; min-height:100vh; width:100vw;\">
    ...
    <div class=\"main\">
        ...
        yield "            ";
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "flashes", ["error"], "method", false, false, false, 189));
        foreach ($context['_seq'] as $context["_key"] => $context["msg"]) {
            // line 190
        ...
        yield "\" class=\"back-link\">← Retour aux événements</a>
            ...
            <div class=\"page-grid\">
                ...
                <div class=\"detail-card\">
                    ";
        // line 199
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "image", [], "any", false, false, false, 199)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 200
            yield "                        <img src=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/" . CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "image", [], "any", false, false, false, 200))), "html", null, true);
            yield "\" class=\"detail-img\" alt=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "title", [], "any", false, false, false, 200), "html", null, true);
            yield "\">
                    ";
        } else {
            // line 202
        ...
        // line 211
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "title", [], "any", false, false, false, 211), "html", null, true);
        yield "</h1>
        ...
        // line 216
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "price", [], "any", false, false, false, 216), "html", null, true);
        yield " DT</span>
                            </div>
                            <div class=\"meta-box\">
        ...
        // line 220
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "capacity", [], "any", false, false, false, 220), "html", null, true);
        yield " places</span>
                            </div>
                            <div class=\"meta-box\">
                                ...
                                <span class=\"meta-value\">";
        // line 224
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "date", [], "any", false, false, false, 224)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "date", [], "any", false, false, false, 224), "d/m/Y"), "html", null, true)) : ("À confirmer"));
        yield "</span>
                            </div>
                            <div class=\"meta-box\">
                                ...
                                <span class=\"meta-value\">";
        // line 228
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "date", [], "any", false, false, false, 228)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "date", [], "any", false, false, false, 228), "H:i"), "html", null, true)) : ("-"));
        yield "</span>
                            </div>
                        </div>
        ...
        // line 233
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "description", [], "any", false, false, false, 233), "html", null, true);
        yield "</div>
        ...
        // line 241
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::urlencode(CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "lieu", [], "any", false, false, false, 241)), "html", null, true);
        yield "&output=embed\">
                            </iframe>
        ...
        // line 246
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "lieu", [], "any", false, false, false, 246), "html", null, true);
        yield "</div>
                                </div>
                                <a href=\"https://www.google.com/maps/dir/?api=1&destination=";
        // line 248
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::urlencode(CoreExtension::getAttribute($this->env, $this->source, ($context["evenement"] ?? null), "lieu", [], "any", false, false, false, 248)), "html", null, true);
        yield "\"
...
";
    ...
    {
        return array (  375 => 248,  370 => 246,  362 => 241,  351 => 233,  343 => 228,  336 => 224,  329 => 220,  322 => 216,  314 => 211,  305 => 204,  301 => 202,  293 => 200,  291 => 199,  282 => 193,  279 => 192,  270 => 190,  265 => 189,  256 => 187,  252 => 186,  70 => 6,  63 => 5,  52 => 3,  41 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "evenement/show.html.twig", "C:\\Users\\MSI\\Desktop\\final_bizcore\\ESPRIT-PIDEV-WEB-3A7-2026-BIZCORE\\templates\\evenement\\show.html.twig");
    }
}
