...
class __TwigTemplate_69a0ddd6ec80e73bb4b9d91474b093d1 extends Template
{
...
<div class=\"page\">
    ...
    ";
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "flashes", ["success"], "method", false, false, false, 101));
        ...
        yield "    ";
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "flashes", ["error"], "method", false, false, false, 102));
        foreach ($context['_seq'] as $context["_key"] => $context["msg"]) {
        ...
        yield "    ";
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "flashes", ["warning"], "method", false, false, false, 103));
        foreach ($context['_seq'] as $context["_key"] => $context["msg"]) {
    ...
    ";
        // line 106
        yield "    ";
        $context["nb_attente"] = Twig\Extension\CoreExtension::length($this->env->getCharset(), Twig\Extension\CoreExtension::filter($this->env, ($context["signalements"] ?? null), function ($__s__) use ($context, $macros) { $context["s"] = $__s__; return (CoreExtension::getAttribute($this->env, $this->source, ($context["s"] ?? null), "statut", [], "any", false, false, false, 106) == "en_attente"); }));
        // line 107
        yield "    ";
        $context["nb_traite"] = Twig\Extension\CoreExtension::length($this->env->getCharset(), Twig\Extension\CoreExtension::filter($this->env, ($context["signalements"] ?? null), function ($__s__) use ($context, $macros) { $context["s"] = $__s__; return (CoreExtension::getAttribute($this->env, $this->source, ($context["s"] ?? null), "statut", [], "any", false, false, false, 107) == "traite"); }));
        // line 108
        yield "    ";
        $context["nb_rejete"] = Twig\Extension\CoreExtension::length($this->env->getCharset(), Twig\Extension\CoreExtension::filter($this->env, ($context["signalements"] ?? null), function ($__s__) use ($context, $macros) { $context["s"] = $__s__; return (CoreExtension::getAttribute($this->env, $this->source, ($context["s"] ?? null), "statut", [], "any", false, false, false, 108) == "rejete"); }));
        // line 109
        yield "
    <div class=\"stats-row\">
        <div class=\"stat-chip\"><span class=\"stat-icon\">📋</span><div><div class=\"stat-val\">";
        // line 111
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["signalements"] ?? null)), "html", null, true);
        ...
        // line 113
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["nb_traite"] ?? null), "html", null, true);
        ...
        // line 114
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["nb_rejete"] ?? null), "html", null, true);
    ...
    <div class=\"card\">
        ";
        // line 118
        if (Twig\Extension\CoreExtension::testEmpty(($context["signalements"] ?? null))) {
            // line 119
        ...
        ";
            ...
            // line 138
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable(($context["signalements"] ?? null));
            foreach ($context['_seq'] as $context["_key"] => $context["s"]) {
                ...
                yield "\">
                                        ";
                // line 144
                yield (((CoreExtension::getAttribute($this->env, $this->source, ($context["article_map"] ?? null), CoreExtension::getAttribute($this->env, $this->source, $context["s"], "idArticle", [], "any", false, false, false, 144), [], "array", true, true, false, 144) &&  !(null === (($_v0 = ($context["article_map"] ?? null)) && is_array($_v0) || $_v0 instanceof ArrayAccess ? ($_v0[CoreExtension::getAttribute($this->env, $this->source, $context["s"], "idArticle", [], "any", false, false, false, 144)] ?? null) : null)))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v1 = ($context["article_map"] ?? null)) && is_array($_v1) || $_v1 instanceof ArrayAccess ? ($_v1[CoreExtension::getAttribute($this->env, $this->source, $context["s"], "idArticle", [], "any", false, false, false, 144)] ?? null) : null), "html", null, true)) : ("(supprimé)"));
                yield "
                                    </a>
                                </div>
                            </td>
...
<footer>© 2026 <span>Bizcore</span> — Tous droits réservés</footer>
    ...
    {
        return array (  346 => 179,  340 => 175,  331 => 171,  326 => 168,  319 => 164,  315 => 163,  310 => 162,  308 => 161,  304 => 160,  298 => 157,  294 => 155,  290 => 153,  285 => 152,  281 => 151,  277 => 150,  272 => 148,  265 => 144,  261 => 143,  255 => 140,  252 => 139,  248 => 138,  233 => 125,  225 => 119,  223 => 118,  216 => 114,  212 => 113,  208 => 112,  204 => 111,  200 => 109,  197 => 108,  194 => 107,  191 => 106,  188 => 104,  176 => 103,  164 => 102,  153 => 101,  141 => 92,  133 => 87,  129 => 86,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "signalement/index.html.twig", "C:\\Users\\MSI\\Desktop\\final_bizcore\\ESPRIT-PIDEV-WEB-3A7-2026-BIZCORE\\templates\\signalement\\index.html.twig");
    }
}
