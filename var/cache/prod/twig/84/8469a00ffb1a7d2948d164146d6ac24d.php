...
class __TwigTemplate_b9a1700011e129dbaab4661800b886eb extends Template
{
...
<div style=\"display:flex; min-height:100vh;\">
    ...
    <div class=\"main\">
        ...
        yield "\">ARTICLES</a>
                ...
                <span>";
        // line 168
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::slice($this->env->getCharset(), Twig\Extension\CoreExtension::upper($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "titre", [], "any", false, false, false, 168)), 0, 40), "html", null, true);
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "titre", [], "any", false, false, false, 168)) > 40)) {
            yield "…";
        }
        yield "</span>
            </div>
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "flashes", ["success"], "method", false, false, false, 178));
        ...
        yield "            ";
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "flashes", ["error"], "method", false, false, false, 181));
        foreach ($context['_seq'] as $context["_key"] => $context["msg"]) {
            // line 182
        ...
        yield "                <div class=\"detail-header\">
                    <div class=\"detail-header-left\">
                        <div class=\"detail-tags\">
                            ";
        // line 193
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "statut", [], "any", false, false, false, 193) == "publié")) {
            // line 194
            yield "                                <span class=\"tag tag-green\">✓ Publié</span>
                            ";
        } elseif ((CoreExtension::getAttribute($this->env, $this->source,         // line 195
($context["article"] ?? null), "statut", [], "any", false, false, false, 195) == "brouillon")) {
            // line 196
            yield "                                <span class=\"tag tag-yellow\">✎ Brouillon</span>
                            ";
        } elseif ((($tmp = CoreExtension::getAttribute($this->env, $this->source,         // line 197
($context["article"] ?? null), "statut", [], "any", false, false, false, 197)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 198
            yield "                                <span class=\"tag tag-grey\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::capitalize($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "statut", [], "any", false, false, false, 198)), "html", null, true);
            yield "</span>
                            ";
        }
        // line 200
        yield "                            ";
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "categorie", [], "any", false, false, false, 200)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 201
            yield "                                <span class=\"tag tag-blue\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "categorie", [], "any", false, false, false, 201), "html", null, true);
            yield "</span>
                            ";
        }
        // line 203
        yield "                            <span class=\"tag tag-grey\">📰 Article #";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "idArticle", [], "any", false, false, false, 203), "html", null, true);
        yield "</span>
                        </div>
                        <div class=\"detail-title\">";
        // line 205
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "titre", [], "any", false, false, false, 205), "html", null, true);
        yield "</div>
                        <div class=\"detail-meta-row\">
                            <span class=\"meta-item\"><strong>Vues :</strong> 👁 ";
        // line 207
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "nombreVues", [], "any", false, false, false, 207), "html", null, true);
        yield "</span>
                            ";
        // line 208
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "categorie", [], "any", false, false, false, 208)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 209
            yield "                                <span class=\"meta-item\"><strong>Catégorie :</strong> ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "categorie", [], "any", false, false, false, 209), "html", null, true);
            yield "</span>
                            ";
        }
        // line 211
        yield "                        </div>
                    ...
                    <div class=\"action-btns-header\">
                        <a href=\"";
        // line 214
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("article_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "idArticle", [], "any", false, false, false, 214)]), "html", null, true);
        yield "\" class=\"btn-edit-h\">✏ Modifier</a>
                        <form method=\"post\" action=\"";
        // line 215
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("article_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "idArticle", [], "any", false, false, false, 215)]), "html", null, true);
        yield "\" style=\"display:inline;\">
                            <input type=\"hidden\" name=\"_token\" value=\"";
        // line 216
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "idArticle", [], "any", false, false, false, 216))), "html", null, true);
        yield "\">
        ...
        // line 223
        yield "                ";
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "imagePrincipale", [], "any", false, false, false, 223)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 224
            yield "                    <img src=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/" . CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "imagePrincipale", [], "any", false, false, false, 224))), "html", null, true);
            yield "\" class=\"detail-img\" alt=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "titre", [], "any", false, false, false, 224), "html", null, true);
            yield "\">
                ";
        } else {
            // line 226
        ...
        // line 233
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "contenu", [], "any", false, false, false, 233), "html", null, true);
        yield "</div>
        ...
        yield "                    <div class=\"meta-grid\">
                        <div class=\"meta-box\">
                            ...
                            <div class=\"value\">";
        // line 239
        yield (((CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "categorie", [], "any", true, true, false, 239) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "categorie", [], "any", false, false, false, 239)))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "categorie", [], "any", false, false, false, 239), "html", null, true)) : ("—"));
        yield "</div>
                        </div>
                        <div class=\"meta-box\">
                            ...
                            <div class=\"value\">";
        // line 243
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "statut", [], "any", false, false, false, 243)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::capitalize($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "statut", [], "any", false, false, false, 243)), "html", null, true)) : ("—"));
        yield "</div>
                        </div>
                        <div class=\"meta-box\">
                            ...
                            <div class=\"value\">👁 ";
        // line 247
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "nombreVues", [], "any", false, false, false, 247), "html", null, true);
        yield "</div>
                        </div>
                        <div class=\"meta-box\">
                            ...
                            <div class=\"value\">#";
        // line 251
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "idArticle", [], "any", false, false, false, 251), "html", null, true);
        yield "</div>
                        </div>
                    </div>
...
const ARTICLE_ID = ";
        // line 303
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "idArticle", [], "any", false, false, false, 303), "html", null, true);
        yield ";
...
";
    ...
    {
        return array (  488 => 303,  480 => 297,  478 => 296,  475 => 294,  455 => 275,  445 => 266,  437 => 259,  430 => 251,  423 => 247,  416 => 243,  409 => 239,  404 => 236,  399 => 233,  396 => 232,  391 => 228,  387 => 226,  379 => 224,  376 => 223,  367 => 216,  363 => 215,  359 => 214,  354 => 211,  348 => 209,  346 => 208,  342 => 207,  337 => 205,  331 => 203,  325 => 201,  322 => 200,  316 => 198,  314 => 197,  311 => 196,  309 => 195,  306 => 194,  304 => 193,  299 => 190,  292 => 185,  289 => 184,  280 => 182,  275 => 181,  266 => 179,  262 => 178,  246 => 168,  241 => 166,  214 => 142,  210 => 141,  205 => 139,  70 => 6,  63 => 5,  52 => 3,  41 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "article/show.html.twig", "C:\\Users\\MSI\\Desktop\\final_bizcore\\ESPRIT-PIDEV-WEB-3A7-2026-BIZCORE\\templates\\article\\show.html.twig");
    }
}
