...
class __TwigTemplate_f47e985b69ac91bc628de79d7addd8c7 extends Template
{
    ...
    <div class=\"bc-main\">
        ...
        yield "                ";
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "flashes", ["error"], "method", false, false, false, 18));
        foreach ($context['_seq'] as $context["_key"] => $context["msg"]) {
            // line 19
        ...
        yield "                    <div class=\"payment-amount\">
                        ...
                        <span class=\"amount\">";
        // line 31
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatNumber(($context["total"] ?? null), 2, ".", " "), "html", null, true);
        yield " €</span>
                    </div>
...
";
    ...
    {
        return array (  187 => 69,  180 => 68,  156 => 48,  150 => 45,  146 => 44,  141 => 43,  132 => 35,  126 => 31,  122 => 29,  113 => 21,  104 => 19,  99 => 18,  90 => 16,  86 => 15,  76 => 8,  71 => 5,  64 => 4,  53 => 2,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "payment/index.html.twig", "C:\\Users\\MSI\\Desktop\\final_bizcore\\ESPRIT-PIDEV-WEB-3A7-2026-BIZCORE\\templates\\payment\\index.html.twig");
    }
}
