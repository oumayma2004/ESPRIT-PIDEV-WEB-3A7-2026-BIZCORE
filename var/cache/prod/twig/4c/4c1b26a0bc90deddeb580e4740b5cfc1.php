...
class __TwigTemplate_6d9f2065f03165b0712bf055fdd46686 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(($context["form"] ?? null), 'form_start', ["attr" => ["novalidate" => "novalidate", "id" => "coachForm"]]);
        yield "
...
<div class=\"row g-3 mb-4\">
    ...
    ";
        ...
        ";
        // line 24
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "nom", [], "any", false, false, false, 24), 'widget', ["attr" => ["class" => "form-control", "placeholder" => "Nom du coach"]]);
        yield "
    ...
    <div class=\"col-md-6\">
        ...
        ";
        // line 30
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "prenom", [], "any", false, false, false, 30), 'widget', ["attr" => ["class" => "form-control", "placeholder" => "Prénom du coach"]]);
        yield "
        <div class=\"field-hint\" data-field=\"coach[prenom]\" style=\"display:none;color:#dc3545;font-size:11px;margin-top:3px;\"></div>
        ";
        // line 32
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "prenom", [], "any", false, false, false, 32), 'errors');
        yield "
    </div>
    ...
    ";
        ...
        ";
        // line 38
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "biographie", [], "any", false, false, false, 38), 'widget', ["attr" => ["class" => "form-control", "rows" => 4, "placeholder" => "Description du coach (min 10 caractères)..."]]);
        yield "
        ...
        ";
        // line 43
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "biographie", [], "any", false, false, false, 43), 'errors');
        yield "
    </div>
    ...
    ";
        ...
        ";
        // line 49
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "experienceAnnees", [], "any", false, false, false, 49), 'widget', ["attr" => ["class" => "form-control", "placeholder" => "Ex: 5"]]);
        yield "
        <div class=\"field-hint\" data-field=\"coach[experienceAnnees]\" style=\"display:none;color:#dc3545;font-size:11px;margin-top:3px;\"></div>
        ";
        // line 51
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "experienceAnnees", [], "any", false, false, false, 51), 'errors');
        yield "
    </div>
    <div class=\"col-md-6\">
        ...
        ";
        // line 55
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "tarifHoraire", [], "any", false, false, false, 55), 'widget', ["attr" => ["class" => "form-control", "placeholder" => "Ex: 45,00 DT"]]);
        yield "
        <div class=\"field-hint\" data-field=\"coach[tarifHoraire]\" style=\"display:none;color:#dc3545;font-size:11px;margin-top:3px;\"></div>
        ";
        // line 57
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "tarifHoraire", [], "any", false, false, false, 57), 'errors');
        yield "
    </div>
    ...
    ";
        ...
        ";
        // line 63
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "disponibilite", [], "any", false, false, false, 63), 'widget', ["attr" => ["class" => "form-select"]]);
        yield "
        <div class=\"field-hint\" data-field=\"coach[disponibilite]\" style=\"display:none;color:#dc3545;font-size:11px;margin-top:3px;\"></div>
        ";
        // line 65
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "disponibilite", [], "any", false, false, false, 65), 'errors');
        yield "
    </div>
    ...
    ";
        ...
        yield "        <div style=\"display:none;\">
            ";
        // line 76
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "numTel", [], "any", false, false, false, 76), 'widget', ["id" => "phone-hidden-field"]);
        yield "
        </div>
        ...
        ";
        // line 109
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "numTel", [], "any", false, false, false, 109), 'errors');
        yield "
    </div>
    ...
    ";
        ...
        ";
        // line 115
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "domaine", [], "any", false, false, false, 115), 'widget', ["attr" => ["class" => "form-select"]]);
        yield "
        <div class=\"field-hint\" data-field=\"coach[domaine]\" style=\"display:none;color:#dc3545;font-size:11px;margin-top:3px;\"></div>
        ";
        // line 117
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "domaine", [], "any", false, false, false, 117), 'errors');
        yield "
    </div>
    ...
    ";
        ...
        ";
            // line 124
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "certification", [], "any", false, false, false, 124), 'widget', ["attr" => ["class" => "form-control"]]);
            yield "
        ";
            // line 125
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "certification", [], "any", false, false, false, 125), 'errors');
            yield "
    </div>
    ";
        }
...
";
    ...
    {
        return array (  430 => 311,  294 => 177,  262 => 144,  257 => 141,  249 => 136,  243 => 132,  238 => 128,  232 => 125,  228 => 124,  224 => 122,  221 => 121,  215 => 117,  210 => 115,  206 => 113,  200 => 109,  193 => 104,  184 => 96,  167 => 80,  161 => 76,  158 => 75,  153 => 71,  147 => 65,  142 => 63,  138 => 61,  132 => 57,  127 => 55,  120 => 51,  115 => 49,  111 => 47,  105 => 43,  97 => 38,  93 => 36,  87 => 32,  82 => 30,  75 => 26,  70 => 24,  66 => 22,  47 => 4,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "admin/coach/_form.html.twig", "C:\\Users\\MSI\\Desktop\\final_bizcore\\ESPRIT-PIDEV-WEB-3A7-2026-BIZCORE\\templates\\admin\\coach\\_form.html.twig");
    }
}
